                    ...
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="Friend">Friend</label>
                                        <input type="password" id="Friend" class="form-control"
                                            name="Friend" placeholder="Friend">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="Photos">Photos</label>
                                        <input type="password" id="Photos" class="form-control"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <input type="password" id="Comments" class="form-control"
